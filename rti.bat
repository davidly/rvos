...
echo running test app %~1 using brk heap >>"%outputfile%"
rvos -h:30 linux\rvos -h:10 -m:0 debianrv\rust\%~1 >>"%outputfile%"

echo running test app %~1 using mmap >>"%outputfile%"
rvos -h:30 linux\rvos -h:0 -m:10 debianrv\rust\%~1 >>"%outputfile%"
...
rvos -h:30 linux\rvos linux\tcrash ml >>%outputfile%

echo running tcrash memory high >>%outputfile%
rvos -h:30 linux\rvos linux\tcrash mh >>%outputfile%

echo running tcrash pc low >>%outputfile%
rvos -h:30 linux\rvos linux\tcrash pcl >>%outputfile%

echo running tcrash pc high >>%outputfile%
rvos -h:30 linux\rvos linux\tcrash pch >>%outputfile%

echo running tcrash stack pointer low >>%outputfile%
rvos -h:30 linux\rvos linux\tcrash spl >>%outputfile%

echo running tcrash stack pointer l=high >>%outputfile%
rvos -h:30 linux\rvos linux\tcrash sph >>%outputfile%

echo running tcrash stack pointer misaligned >>%outputfile%
rvos -h:30 linux\rvos linux\tcrash spm >>%outputfile%

echo running ba tp.bas >>%outputfile%
rvos -h:30 linux\rvos linux\ba linux\tp.bas >>%outputfile% >>%outputfile%

echo running mysort >>%outputfile%
del linux\sorted.txt
rvos -h:30 linux\rvos -h:2 linux\mysort -q -u linux\words.txt linux\sorted.txt >>%outputfile%
head linux\sorted.txt >>%outputfile%

echo running an with brk>>%outputfile%
rvos -h:50 linux\rvos -h:40 -m:0 linux\an david lee >>%outputfile%

echo running an with mmap >>%outputfile%
rvos -h:50 linux\rvos -h:0 -m:40 debianrv\an phoebe bridgers >>%outputfile%
