...
* Notes:
    ...
    * Only a subset of instructions are implemented; just the ones used by test apps that I could validate using g++.
...
an illegal access to memory. It was used for the crash dump above. 
