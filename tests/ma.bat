...
rem build the rvos shell with rvos_print_text()

as -a=rvos_shell.lst --defsym DEFINESTART=1 -mabi=lp64f -march=rv64imaf%RVCFLAG% -fpic rvos_shell.s -o rvos_shell.o

as -a=%1.lst -mabi=lp64f -march=rv64imaf%RVCFLAG% -fpic %1.s -o %1.o
