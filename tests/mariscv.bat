...
as -a=riscv_shell.lst -mabi=lp64f -march=rv64imafc -fpic riscv_shell.s -o riscv_shell.o

rem as -a=%1.lst -mabi=lp64f -march=rv64imaf -fpic %1.s -o %1.o

riscv64-unknown-elf-g++ ^
   %1.c ^
  -mcmodel=medany -mabi=lp64f -march=rv64imafc -fno-common -ffunction-sections -fdata-sections -fstrict-volatile-bitfields ^
